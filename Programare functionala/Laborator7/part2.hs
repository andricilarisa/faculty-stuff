...
executaInstr f (Atrib v e)= update f v (evalp e f)
{-
...
executaProgram valuatie (i:is) = executaProgram  (executaProgram (executaInstr valuatie i) is) is
...
evalProgram prog = executaProgram  prog 
